...
export class NewCreatedEvent extends ethereum.Event {
  get params(): NewCreatedEvent__Params {
    return new NewCreatedEvent__Params(this);
  }
}

export class NewCreatedEvent__Params {
  _event: NewCreatedEvent;

  constructor(event: NewCreatedEvent) {
    this._event = event;
  }
